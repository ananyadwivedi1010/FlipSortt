          ...
          <div className="flex space-x-10">
            {['Home', 'Dashboard'].map((view) => (
              <button
                ...
                className={`text-[11px] font-black uppercase tracking-[0.2em] transition-all duration-300 border-b-2 py-1 ${
                  currentView === view ? 'border-[#2874f0] text-white' : 'border-transparent text-gray-500 hover:text-white hover:border-white/20'
                }`}
              >
                {view}
              </button>
